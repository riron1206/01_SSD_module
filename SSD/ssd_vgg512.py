...
def create_model(num_classes=2):
    ...
    net['conv6_1'] = ZeroPadding2D()(net['conv6_1']) # 追加
    ...
    net['conv8_1'] = ZeroPadding2D()(net['conv8_1']) # 追加
    net['conv8_2'] = Conv2D(256, (3, 3), strides=(2, 2),
                                   activation='relu', padding='same',
                                   name='conv8_2')(net['conv8_1'])
    # Block 9 追加
    net['conv9_1'] = Conv2D(128, (1, 1), activation='relu',
                                   padding='same',
                                   name='conv9_1')(net['conv8_2'])
    net['conv9_1'] = ZeroPadding2D()(net['conv9_1'])
    net['conv9_2'] = Conv2D(256, (4, 4), strides=(1, 1),
                                   activation='relu', padding='same',
                                   name='conv9_2')(net['conv9_1'])

    # Last Pool
    net['pool6'] = GlobalAveragePooling2D(name='pool6')(net['conv9_2'])
    ...
    priorbox = PriorBox(img_size, 330.0, max_size=330.0+54.0, aspect_ratios=[2, 3], # 変更
                        variances=[0.1, 0.1, 0.2, 0.2],
...
def create_prior_box():
    box_configs = [
        ...
        {'layer_width': 1, 'layer_height': 1, 'num_prior': 6, 'min_size': 330.0,
         'max_size': 330.0+54.0, 'aspect_ratios': [1.0, 1.0, 2.0, 1 / 2.0, 3.0, 1 / 3.0]}, # 追加
    ]
